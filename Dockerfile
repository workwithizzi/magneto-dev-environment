...
# ? Commands are executed as 'app' user by default
...
# ? Because /var/www is mounted as a volume from the previous docker image, all permissions and commands involving those things has to be done after container is built.
